...
@Sql(scripts = {"classpath:supermarket-schema.sql","classpath:supermarket-data.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)// PRE-POPULATE OUT H2 DB
@ActiveProfiles("test")
...
void testCreate() throws Exception {
	...
	Supermarket create = new Supermarket("Peas",500,"Frozen");//object
